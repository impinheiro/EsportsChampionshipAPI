...
public record ChampionshipDTO(String id, String name, String gameName,
                              ChampionshipType type, Integer capacity,
                              double subscriptionValue, ChampionshipFormat format,
                              String rules, LocalDateTime startDate, LocalDateTime endDate,
                              String location, String coverImage, String logoImage,
                              String awardDescription, List<RegistrationDTO> registrations, LocalDateTime createdAt, LocalDateTime updatedAt)  {
